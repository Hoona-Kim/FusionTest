Shader "Unreal/M_Halberdhair"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Halberd_05_hair_D", 2D ) = "white" {}
		Material_Texture2D_1( "T_Halberd_05_hairMetSmooth", 2D ) = "white" {}
